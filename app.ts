...
const app = express();
const TARGET_API_URL = process.env.TARGET_API_URL || "https://api.openai.com/v1";
...
if (API_KEYS.length === 0) {
  throw new Error('Either API_KEY or API_KEYS environment variable is required');
}
...
app.options("/nos-proxy/*splat", handleCorsOptions);

// Main proxy route
app.all("/nos-proxy/*splat", async (req, res) => {
